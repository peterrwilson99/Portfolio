...
export const projects: Project[] = [
    ...
    },
    {
        ...
        images: ["/images/nbahofpredictor1.png", "/images/nbahofpredictor2.png", "/images/nbahofpredictor3.png", "/images/nbahofpredictor4.png"],
    ...
    },
    {
        ...
        date: "July 2023",
        preview:
            "A Python project to transfer playlists from Apple Music to Spotify, using Selenium for web scraping and Spotipy to interact with Spotify's Web API.",
        description:
        ...
        images: ["/images/appletospotify.png"],
    ...
    },
    {
        ...
        images: ["/images/migoy1.png", "/images/migoy2.png", "/images/migoy3.png", "/images/migoy4.png"],
    ...
    },
    {
        ...
        description:
            "A simple web application to display the time with an aesthetic background using NextJS and Vercel. Great for work stations where a monitor isn't being used. Uses Unsplash.com for its random image generator, where every minute the application grabs a new image to display.",
        images: ["/images/clock1.png", "/images/clock2.png"],
        github: null,
    ...
    },
    {
        ...
        images: ["/images/idf1.png", "/images/idf2.png"],
    ...
    },
    {
        ...
        images: ["/images/uvic1.png", "/images/uvic2.png", "/images/uvic3.png"],
